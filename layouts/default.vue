...
<template>
    <div>
        <nav class="fixed top-0 z-50 md:z-20 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <div class="px-3 py-3 lg:px-5 lg:pl-3">
                <div class="flex items-center justify-between">
                    <div id="topnav-right-side" class="sm:ms-64 flex items-center justify-start rtl:justify-end">
                        <button @click="openModal()" aria-controls="logo-sidebar" type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg  hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                ...
                <ul class="space-y-2 font-medium">
                    <li>
                        <NuxtLink to="/" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span id="sidebar-menu-home" class="ms-3">Home</span>
                        </NuxtLink>
                    </li>
                    <li>
                        <NuxtLink to="/product" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span id="sidebar-menu-product" class="flex-1 ms-3 whitespace-nowrap">Product</span>
                        </NuxtLink>
                    </li>
                </ul>
            </div>
        ...
        <div id="drawer-backdrop" class="hidden bg-gray-900/50 dark:bg-gray-900/80 fixed inset-0 z-30"></div>
    </div>
  </template>